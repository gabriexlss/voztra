...
A licença MIT deste repositório cobre o código do Voztra. Dependências, modelos e seus avisos mantêm as respectivas licenças.

- Electron / Chromium / Node.js: distribuição inclui LICENSE.electron.txt e LICENSES.chromium.html.
- React, Vite, Tailwind CSS, shadcn/ui e Radix: interface e ferramentas, predominantemente MIT.
- Lucide: ícones, ISC.

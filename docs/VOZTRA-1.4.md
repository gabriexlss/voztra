...
- [ ] Verificações TypeScript/Python/Electron, build Windows e workflow Linux.
...
- Em andamento: empacotamento Windows, verificação do pacote/portable e build Linux no CI.
